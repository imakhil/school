...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                ...
                . 'bottom-hover-color |rgba(126, 0, 158, 1)|'
                . 'bottom-hover-background |#FFF|'
                ...
                . 'iheu-css ||'
                . 'heading-background-color |rgba(176, 0, 199, 1)|'
                        ...
                        <div class="ctu-ultimate-wrapper-3"> 
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <input type="text" class="form-control iheu-vendor-color"   id="heading-background-color" name="heading-background-color" value="<?php echo $styledata[85]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                ...
                                <div class="ctu-ulitate-style-3-tabs " id="ctu-ulitate-style-3-id-4">
                                    ...
                                    <div class="iheu-admin-style-settings-div-right">
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-padding-bottom" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Make distance from Botton, work as percentage of Div" >Padding Bottom</label>
                                            <div class="col-sm-6 nopadding">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-3">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Buttom Color, Based on Color">Font Color <span class="ctu-pro-only">Pro</span> </label>
                                            <div class="col-sm-6 nopadding">
            ...
            <form method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="ctu-title">Hover Background Image  <span class="ctu-pro-only">Pro</span></label>
                            <div class="col-xs-12-div">
                                <div class="col-xs-8-div">
