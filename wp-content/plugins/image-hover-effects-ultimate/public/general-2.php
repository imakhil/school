...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                ...
                . 'background-color |rgba(0, 146, 194, 0.71)|'
                ...
                . 'content-animation ||'
                . 'inner-shadow |0|'
                . 'inner-shadow-color |rgba(0, 146, 194, 0.3)|'
                . 'box-shadow ||'
                . 'box-shadow-color ||'
                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    <option <?php if ($styledata[85] == 'left_to_right') {
                                                        echo 'selected';
                                                    } ?> value="left_to_right">left to Right</option>
                                                    <option <?php if ($styledata[85] == 'right_to_left') {
                                                        echo 'selected';
                                                    } ?> value="right_to_left">Right to left</option>
                                                    <option <?php if ($styledata[85] == 'top_to_bottom') {
                                                        echo 'selected';
                                                    } ?> value="top_to_bottom">Top to Bottom</option>
                                                    <option <?php if ($styledata[85] == 'bottom_to_top') {
                                                        echo 'selected';
...
<?php iheu_content_animation_admin_panel($styledata[23]) ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="inner-shadow-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Inner Shadow Color">Inner Shadow Color <span class="ctu-pro-only">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
