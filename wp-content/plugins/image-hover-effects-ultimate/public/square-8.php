...
<?php iheu_image_animation_admin_data($styledata[19]) ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="animation-durations" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Image Viewing Animation Duration" >Animation Duration <span class="ctu-pro-only">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
...
<?php iheu_font_weight_admin_panel($styledata[65]); ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-hover-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Buttom Hover Background Color, Based on Color">Hover Background <span class="ctu-pro-only">Pro</span> </label>
                                            <div class="col-sm-6 nopadding">
