                            ...
                            <div class="ctu-ultimate-style-3-content">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    ...
                                                    ?> value="left_to_right">Scale In</option>
                                                    <option <?php
                                                    if ($styledata[101] == 'right_to_left') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="right_to_left">Scale Out</option>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Buttom Color, Based on Color">Font Color <span class="ctu-pro-only">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
