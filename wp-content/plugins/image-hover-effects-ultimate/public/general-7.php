                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    <option <?php if($styledata[85]== 'left_to_right'){echo 'selected';}?> value="left_to_right">From Left</option>
                                                    <option <?php if($styledata[85]== 'right_to_left'){echo 'selected';}?> value="right_to_left">From Right</option>
                                                    <option <?php if($styledata[85]== 'top_to_bottom'){echo 'selected';}?> value="top_to_bottom">From Top</option>
                                                    <option <?php if($styledata[85]== 'bottom_to_top'){echo 'selected';}?> value="bottom_to_top">From Bottom</option>
