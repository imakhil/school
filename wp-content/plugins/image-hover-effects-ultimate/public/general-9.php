                            ...
                            <div class="ctu-ultimate-style-3-content">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-3">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Buttom background Color, Based on Color">Background Color <span class="ctu-pro-only">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-hover-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Buttom Hover Color, Based on Color">Hover Color <span class="ctu-pro-only">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
