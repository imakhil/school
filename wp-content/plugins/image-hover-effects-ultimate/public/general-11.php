...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'iheueffectsstyle')) {
        ...
        $data = 'iheu-item |' . sanitize_text_field($_POST['iheu-item']) . '|'
                ...
                . 'background-color |' . sanitize_hex_color($_POST['background-color']) . '|'
                ...
                . 'desc-font-color |' . sanitize_hex_color($_POST['desc-font-color']) . '|'
                ...
                . 'bottom-font-color |' . sanitize_hex_color($_POST['bottom-font-color']) . '|'
                . 'bottom-font-background |' . sanitize_hex_color($_POST['bottom-font-background']) . '|'
                ...
                . 'bottom-hover-color |' . sanitize_hex_color($_POST['bottom-hover-color']) . '|'
                . 'bottom-hover-background |' . sanitize_hex_color($_POST['bottom-hover-background']) . '|'
                        ...
                        <div class="ctu-ultimate-wrapper-3"> 
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            ...
                                            <div class="col-sm-6 nopadding">
                                                <select class="form-control" id="iheu-directions" name="iheu-directions">
                                                    <option <?php
                                                    if ($styledata[85] == 'left_to_right') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="left_to_right">left to Right</option>
                                                    <option <?php
                                                    if ($styledata[85] == 'right_to_left') {
                                                        echo 'selected';
                                                    }
                                ...
                                <div class="ctu-ulitate-style-3-tabs " id="ctu-ulitate-style-3-id-4">
                                    ...
                                    <div class="iheu-admin-style-settings-div-right">
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-padding-bottom" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Make distance from Button, word as percentage of Div" >Padding Bottom</label>
                                            <div class="col-sm-6 nopadding">
