	...
	*/
	class LA_Caption_Hover {
		...
		function render_submenu_page(){
			...
			<div class="postbox">
				<h3><span><?php _e( 'Available in Pro Version' ); ?></span></h3>
				<div class="inside">
					<p><?php _e( 'Rate 5 stars to plugin to get this option for free version.After rating contact me.' ); ?></p>
					<a href="https://wordpress.org/support/plugin/image-hover-effects/reviews/?filter=5" target="_blank">Rate now to unlock this feature.</a>
				</div>
